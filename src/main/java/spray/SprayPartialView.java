...
public class SprayPartialView extends AAgingPartialView {
     ...
     * sample in argument
     *
     * @param sample the list containing the elements to replace
     * @param old    the peer to replace
     * @param fresh  the peer to insert
     ...
     *
     * @param neighbor the neighbor to remove from the neighborhood
