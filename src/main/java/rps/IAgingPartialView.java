...
public interface IAgingPartialView {
     ...
     *
     * @param caller      the identity of the peer calling this function
     * @param neighbor    the chosen neighbor to exchange with
     * @param isInitiator define if the caller is the initiator of the exchange
     ...
     * sample
     *
     * @param me          the peer that calls the merge function
     * @param other       the other peer that sent a message to the "me" peer
     * @param newSample   the new received sample
